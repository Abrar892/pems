...
const services = [
  {
    ...
    image: "/engineer-working-with-robot-modern-industrial-facility.jpg",
    imagePos: "center",
  },
  {
    id: "02",
  ...
  {
    id: "09",
    title: "Hydraulic Bolt Torquing & Core Cutting",
    desc: "Professional hydraulic bolt torquing for controlled tightening, along with precision diamond core cutting for concrete and structural applications.",
